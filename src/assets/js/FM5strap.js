/*!
 * FM5strap v3.0.0-beta (https://Fermoto5HD.com) - Basado en Bootstrap v4.0.0-alpha6
 * Copyright 2011-2017 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)
 */

if (typeof jQuery === 'undefined') {
  throw new Error('Para utilizar FM5strap se necesita de jQuery y debe ser incluido antes del JS de FM5strap.')
}
...
/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+bash+git+json+markdown+php+php-extras+sass+scss+sql&plugins=line-numbers+toolbar+jsonp-highlight+show-language+copy-to-clipboard */
