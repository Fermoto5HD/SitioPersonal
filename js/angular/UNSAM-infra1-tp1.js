angular.module('FM5HD').controller('UNSAM-infra1-tp1', function ($scope, $http, $compile) {
	$.ajaxSetup ({
		cache: false
	});
	...
	$scope.mostrarcalculos = function(valor) {
		...
		if (valor) {
			...
			$('.btn.btn-primary#calculos').prop('ng-click', 'mostrarcalculos(true)').text('Mostrar cálculos'); 
		}
	}
}); 